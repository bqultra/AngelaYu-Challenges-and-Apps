...
struct StoryBrain {
    ...
    mutating func nextStory(_ userChoice: String) {
        ...
        switch userChoice {
        case stories[storyNumber].answer1:
            storyNumber = stories[storyNumber].answer1Dest
        case stories[storyNumber].answer2:
            storyNumber = stories[storyNumber].answer2Dest
        default:
            print("Error")
        }
    ...
    func getMainText() -> String {
        ...
        return stories[storyNumber].storyText
